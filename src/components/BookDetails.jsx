        ...
        <div className=" p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2">
          ...
          {fold ? (
            <>
              ...
              <span className="cursor-pointer text-blue-700 font-bold" onClick={()=> setFold(!fold)}>Read More</span>
            </>
          ) : (
            <>
              ...
              <span className="cursor-pointer text-blue-700 font-bold" onClick={()=> setFold(!fold)}>Read less</span>
            </>
          )}
